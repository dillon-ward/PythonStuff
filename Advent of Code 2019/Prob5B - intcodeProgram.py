...
for x in range (len(inputCode)):
    value_1 = False
    value_2 = False
    if not position:
        numbers.append(inputCode[x])
    else:
        numbers.append(inputCode[position])
        position += 1
    print (numbers)
    #-------------------------------
    if numbers[0] == 99:
    ...
    #-------------------------------
        if (len(numbers) == 3):
            if instruction == '5' and value_1 != 0:
                position = value_2
                numbers = []
            elif instruction == '6' and value_1 == 0:
                position = value_2
                numbers = []
    #-------------------------------
        elif (len(numbers) == 4):
            if instruction == '1':
                ...
                inputCode[numbers[3]] = lessThan(value_1, value_2)
            else:
                inputCode[numbers[3]] = equalTo(value_1, value_2)
            numbers = []
